/**
 * Stalin-specific types and colour/label constants.
 *
 * These extend the generic graph-types with the factions, edge types, and
 * colour palettes specific to "Stalin: The Court of the Red Tsar".
 */
...
// Re-export generic GraphData as-is
export type GraphData = GenericData;

// ---------------------------------------------------------------------------
// Stalin-specific union types
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Stalin-specific GraphNode / GraphLink — extend generic with narrower types
// ---------------------------------------------------------------------------
